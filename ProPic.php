...
if(isset($_POST["submit"])) {
  ...
  if (in_array($imageFileType, $mime_type_arr)) {
  	...
  	if ($_FILES["image_to_up"]["size"] > 5000000) {
	  $imgErr .= " Sorry, your file is larger than 5MB";
	  $uploadOk = 0;
	} else {
		if (file_exists($target_file)) {
		  ...
		  $uploadOk = 0;
			...
			if (move_uploaded_file($_FILES["image_to_up"]["tmp_name"], $target_file)) {
			    ...
			    $imgErr .= "Sorry, there was an problem with your file.";
			  }
		}
	}
  } else {
  	$imgErr .= " please choose a file first & only JPG, JPEG & PNG files are allowed";
	$uploadOk = 0;
  }
}
?>
...
<img src="image.jpg" alt="Select an image"><br>
